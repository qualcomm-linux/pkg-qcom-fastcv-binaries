...
### Installation
- Make sure to install [Fastrpc Debian package](https://github.com/qualcomm/fastrpc/tree/development) otherwise FastCV Debian package will give dependency errors.
- Install the package using command: `sudo dpkg -i qcom-fastcv-binaries1_1.8.6-1_arm64.deb`
- Once installation is complete one should see `libfastcvopt.so.1` in `/usr/lib/aarch64-linux-gnu`.
...
To enable runtime logs for debugging purposes use below command:<br>
  `adb shell setprop vendor.runtime.fastcv.log 1`<br>
...
pkg-qcom-fastcv-binaries is licensed under the [BSD-3-Clause License](https://spdx.org/licenses/BSD-3-Clause.html). See [LICENSE.txt](https://github.com/qualcomm-linux/pkg-qcom-sensors/blob/qcom/debian/trixie/LICENSE.txt) for the full license text.