# Contributing to Packaging repository for qcom-fastcv-binaries
...
- `qcom/debian/latest` - Debian Forky

Open a PR targeting the specific distro branch you are modifying.
## Submitting a pull request

1. Please read our [code of conduct](CODE-OF-CONDUCT.md) and [license](LICENSE.txt).
1. [Fork](https://github.com/qualcomm-linux/pkg-qcom-fastcv-binaries/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-qcom-fastcv-binaries.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-qcom-fastcv-binaries.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-qcom-fastcv-binaries/pulls) from your branch to the appropriate distro-specific branch (e.g. `qcom/ubuntu/resolute` or
   `qcom/debian/trixie`).
